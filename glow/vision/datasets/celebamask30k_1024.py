...
def vis_parsing_maps(im, parsing_anno, stride, save_im=False, save_path='vis_results/parsing_map_on_im.jpg'):
    ...
    if save_im:
        ...
        cv2.imwrite(save_path.replace(".jpg", '_origin.jpg'), im, [int(cv2.IMWRITE_JPEG_QUALITY), 100])
...
class CelebAMaskHQ256():
    def __init__(self,  n_bits=5, img_size=256, mode=True):
        self.img_path = '/home/thu/dataset/celebamask_hd/CelebAMask-HQ/CelebA-HQ-img'
        self.label_path = '/home/thu/dataset/celebamask_hd/CelebAMask-HQ/mask'
        self.map2CelebAAttr = '/home/thu/dataset/celebamask_hd/CelebAMask-HQ/mask'
        self.celebmask_celeba_mapping_txt = '/home/thu/dataset/celebamask_hd/CelebAMask-HQ/CelebA-HQ-to-CelebA-mapping.txt'

        self.root_celebA = '/home/thu/dataset/celeba_torchvision/celeba/'

        self.mask_name_list  = ['class0_placeholder','skin', 'l_brow', 'r_brow', 'l_eye', 'r_eye', 'eye_g', 'l_ear', 'r_ear', 'ear_r',
        ...
        self.celeba_dicts, self.celeba_attrs = _find_images_and_annotation(self.root_celebA)
        ...
        with open(self.celebmask_celeba_mapping_txt, 'r') as f:
            ...
            for line in lines[1:]:
                ...
                self.celebmaskname2attr[celebmask_id+'.jpg'] = self.celebname2attr[celeba_filename]
    ...
    def __getitem__(self, index):
        ...
        label = Image.open(label_path).convert(
            'P')  # https://github.com/zllrunning/face-parsing.PyTorch/blob/d2e684cf15/face_dataset.py#L48
...
if __name__ == "__main__":
    ...
    celeba = torch.utils.data.DataLoader(
        CelebAMaskHQ256(mode=True), batch_size=4)
    ...
    for _ii, d in enumerate(celeba):
        ...
        vis_parsing_maps(im=img, parsing_anno=label, stride=1,save_im=True, save_path='daemo{}.jpg'.format(_ii))
        print('aa')
        #cv2.imshow("img", img)
